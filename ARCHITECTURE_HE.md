...
## 13. שאלות פתוחות לאישורך (נדרשת הכרעה לפני מימוש)
...
7. **ההקלטה בפועל** - רציפה 24/7 או sessions יזומים? משפיע על חשבון
   הנפח (סעיף 3.3), על שאלות 1-2 ועל בחירת שכבה 0 בסעיף 12.2.
8. **שכבה 0 של סעיף 12** - לאשר את ברירות המחדל: העלאה-אחרי-עצירה
   במצב session, ‏Ethernet נפרד ל-Pi 5, ‏BPF צר בלפטופ רציף?
9. **מניפסט והצלבה משולשת** (סעיף 12.2) כתחליף ל-allow-list - לאשר?
10. **דגל test|prod** ולמידת baseline מ-prod בלבד (סעיף 12.3) - לאשר?
